        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-yellow-50: oklch(.97 .014 254.604);
                    --color-yellow-100: oklch(.932 .032 255.585);
                    --color-yellow-200: oklch(.882 .059 254.128);
                    --color-yellow-300: oklch(.809 .105 251.813);
                    --color-yellow-400: oklch(.707 .165 254.624);
                    --color-yellow-500: oklch(.623 .214 259.815);
                    --color-yellow-600: oklch(.546 .245 262.881);
                    --color-yellow-700: oklch(.488 .243 264.376);
                    --color-yellow-800: oklch(.424 .199 265.638);
                    --color-yellow-900: oklch(.379 .146 265.522);
                    --color-yellow-950: oklch(.282 .091 267.935);
                    --color-yellow-50: oklch(.962 .018 272.314);
                    --color-yellow-100: oklch(.93 .034 272.788);
                    --color-yellow-200: oklch(.87 .065 274.039);
                    --color-yellow-300: oklch(.785 .115 274.713);
                    --color-yellow-400: oklch(.673 .182 276.935);
                    --color-yellow-500: oklch(.585 .233 277.117);
                    --color-yellow-600: oklch(.511 .262 276.966);
                    --color-yellow-700: oklch(.457 .24 277.023);
                    --color-yellow-800: oklch(.398 .195 277.366);
                    --color-yellow-900: oklch(.359 .144 278.697);
                    --color-yellow-950: oklch(.257 .09 281.288);
