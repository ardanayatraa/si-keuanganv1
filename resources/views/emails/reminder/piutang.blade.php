...
<head>
    <meta charset="UTF-8">
    <title>Pengingat Piutang Jatuh Tempo</title>
</head>
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <!-- Header -->
                    <tr>
                        <td style="background:#AED581;padding:20px;text-align:center;">
                            <h1 style="margin:0;font-size:24px;color:#333;">🔔 Pengingat Piutang</h1>
                        </td>
                    </tr>
                    <!-- Body -->
                    <tr>
