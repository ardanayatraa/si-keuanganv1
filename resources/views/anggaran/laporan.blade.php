            ...
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                        ...
                        <p class="mt-1">
                            Pastikan anggaran Anda sudah memperhitungkan cicilan utang yang harus dibayar setiap
                            bulannya.
                        </p>
                    </div>
                </div>
                    ...
                    @forelse($laporan as $item)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <span
                                    class="{{ $item->sisa_anggaran >= 0 ? 'text-green-600' : 'text-red-600' }} font-medium">
        ...
        <div class="mt-6 text-sm text-gray-600 dark:text-gray-400">
            ...
            <p>
                ...
                @if ($totalRealisasi > $totalAnggaran)
                    <span class="text-red-600 font-semibold">⚠️ Total pengeluaran melebihi anggaran sebesar Rp
                        {{ number_format($totalRealisasi - $totalAnggaran, 0, ',', '.') }}</span>
                @endif
            </p>
        </div>
    </div>
